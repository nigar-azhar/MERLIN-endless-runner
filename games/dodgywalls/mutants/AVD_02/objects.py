...
class Player:
	def __init__(self, win):
		...
		self.image = pygame.image.load('games/dodgywalls/actual/Assets/rect.png')
...
class Bar(pygame.sprite.Sprite):
	...
	def get_bar_ycoord(self):
		if self.pos == -1:
			return self.y + self.height
		elif self.pos == 1:
			return self.y #s- self.height
...
class ScoreCard:
	...
	def update(self, score):
		...
		pygame.draw.circle(self.win, (0, 0, 32), (self.x, self.y), 20)
