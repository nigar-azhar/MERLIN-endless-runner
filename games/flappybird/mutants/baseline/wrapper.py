...
# from games.flappybird.mutants.complex.sprites import HeartBoosterGuage
...
class Game():
    ...
    def __init__(self, frame_size=84, width=288, height=512):
        ...
        self.player = Bird(91,240)#(0.2 * width, 0.45 * height)
        self.base = Base()
    ...
    def step(self, action):
        ...
        if self.pipes[0].x+ self.pipes[0].image.get_width() < 0 and len(self.pipes) < 3:
        ...
        if pygame.time.get_ticks() > self.fps * 70:
