...
class Game():
    ...
    def get_game_state(self):
        ...
        topPipe = {'yCoordinate': self.pipes[0].y_upper_end-10 , 'xCoordinate': self.pipes[0].x}
        bottomPipe = {'yCoordinate': self.pipes[0].y_upper_end+160 , 'xCoordinate': self.pipes[0].x}
