...
class Player:
	def __init__(self, win):
		...
		self.image = pygame.image.load(f"games/angrywalls/actual/Assets/red.png")
	...
	def reset(self):
		...
		self.x = random.randint(30, 220)#145
		self.y = 240
...
class Ball(pygame.sprite.Sprite):
	def __init__(self, x, y, type, color, win):
		...
		color_dict = {"red" : (255, 0, 0), "white" : (255, 255, 255), "gray" : (54, 69, 79), "black":(0,0,0)}
...
class Block(pygame.sprite.Sprite):
	def __init__(self, x, y, max, win):
		...
		self.orig = pygame.image.load("games/angrywalls/actual/Assets/block.jpeg")
...
class ScoreCard:
	def __init__(self, x, y, win):
		...
		self.style = "games/angrywalls/actual/Fonts/BubblegumSans-Regular.ttf"
